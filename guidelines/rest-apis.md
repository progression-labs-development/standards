...
- Use `progression-labs/fastify-api` for TypeScript APIs (Fastify)
- Use `progression-labs/llm` for Python LLM APIs (FastAPI is wrapped inside — never build FastAPI directly)
